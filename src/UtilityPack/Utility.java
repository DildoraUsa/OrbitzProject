...
public class Utility {
    ...
    public static void waitForElementToBeClickableOrEnabled(WebDriver driver,int second,By by){
        new WebDriverWait(driver,Duration.ofSeconds(second)).until(ExpectedConditions.elementToBeClickable(by));
    }
